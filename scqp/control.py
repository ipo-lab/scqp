def scqp_control(max_iters=10_000, eps_abs=1e-3, eps_rel=1e-3, eps_infeas=1e-4, check_solved=25, check_feasible=25,
                 alpha=1.2, alpha_iter=100, rho=None, rho_min=1e-6, rho_max=1e6, adaptive_rho=True, adaptive_rho_tol=5,
                 adaptive_rho_iter=50, adaptive_rho_max_iter=1000, sigma=0.0, verbose=False,
                 scale=True, beta=None, warm_start=False, cache_factor=False, **kwargs):
